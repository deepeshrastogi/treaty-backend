          ...
          <table border="0" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="2" align="left">
                <label
                  style="font-family: poppins; font-size: 14px; line-height: 21px; font-weight: 600; padding: 5px 10px 0 10px; text-align: left; color: #727272; display: block;">Nachricht zum Auftrag:</label>
                <p
