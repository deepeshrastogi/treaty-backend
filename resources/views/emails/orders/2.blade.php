        ...
        <td style="border-top:5px solid #01878A; background: #F3F3F3;">
          ...
          <table border="0" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="50%" align="left">
                <label
                  style="font-family: poppins; font-size: 14px; line-height: 21px; font-weight: 600; padding: 5px 10px 0 10px; text-align: left; color: #727272; display: block;">Auftragsthema:</label>
                <p
                  style="font-family: poppins; font-size: 14px; font-weight: 500; padding: 0 10px 10px 10px; margin: 0; text-align: left; color:#323232">
                  @isset($data['orderData']['order_topic_data']['Order_topic_name']){{$data['orderData']['order_topic_data']['Order_topic_name']}}@endisset</p>
              </td>
              <td width="50%" align="left">
                <label
                  style="font-family: poppins; font-size: 14px; line-height: 21px; font-weight: 600; padding: 5px 10px 0 10px; text-align: left; color: #727272; display: block;">Auftragsart:</label>
                <p
                  style="font-family: poppins; font-size: 14px; font-weight: 500; padding: 0 10px 10px 10px; margin: 0; text-align: left; color:#323232">
                  @isset($data['orderData']['order_type_data']['Order_type_name']){{$data['orderData']['order_type_data']['Order_type_name']}}@endisset</p>
              </td>
            </tr>
