@include('emails.header')
      ...
      <tr>
        <td>
          ...
          <p style="font-family: poppins; font-size: 18px; line-height: 21px; font-weight: 500; padding: 15px 10px 0 10px;; text-align: left;color: #000000; margin:0;">Email: <a href="mailto:<?=$data['user_email']?>" style="color: #01878A;text-decoration: none;"><?=$data['user_email']?></a></p>
          <p style="font-family: poppins; font-size: 18px; line-height: 21px; font-weight: 500; padding: 15px 10px 0 10px;; text-align: left;color: #000000; margin:0;">ID:   <?=$data['id']?></p>
          <p style="font-family: poppins; font-size: 18px; line-height: 21px; font-weight: 500; padding: 15px 10px 0 10px;; text-align: left;color: #000000; margin:0;">Name:   <?=$data['name']?></p>
